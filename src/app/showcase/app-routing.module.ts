...
@NgModule({
    imports: [
        RouterModule.forRoot([
			...
			{path: 'steps1', loadChildren: () => import('./components/steps1/stepsdemo1.module').then(m => m.StepsDemoModule1)},
			{path: 'steps2', loadChildren: () => import('./components/steps2/stepsdemo2.module').then(m => m.StepsDemoModule2)},
