...
@Component({
    selector: 'app-topbar',
    template: `
        <div class="layout-topbar" style="background-color: #1E90FF;
      padding: 30px;
      text-align: center;
      font-size: 20px;
      color: white;">
		  ...
		  <div class="layout-footer-left">
			<img width="40" alt="ORL Logo" src="assets/img/Logo.jfif" />
					<span>On the Road Lending</span>
					</div>
			<div class="spacer"></div>
			<div class="layout-footer-right">
			<div class="card highlight-card card-small" >
			<span >LOS - Registration and Loan Application</span>
			</div>
			</div>
