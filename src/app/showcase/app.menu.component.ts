            ...
            <div class="layout-menu">
              <p-panel header="Select">
                  ...
                  <div class="menu-items">
                      <a [routerLink]=" ['/steps']" routerLinkActive="router-link-exact-active">Manage Registration</a>
  					          <a [routerLink]=" ['/steps2']" routerLinkActive="router-link-exact-active">Loan Application</a>
...
export class AppMenuComponent {
    ...
    routes = [
        {
            label: 'Select', value: 'los',
            items: [
                {label: 'Manage Registration', value: '/steps'},
				        {label: 'Edit Registration', value: '/steps1'},
                {label: 'Loan Application', value: '/steps2'}
            ]
        },
        {
